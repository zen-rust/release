...
";
    ...
    assert_eq!(
      ...
      vec![
        Pr {
          number: 1435,
          html_url: Url::parse("https://github.com/release-plz/release-plz/pull/1435").unwrap()
        },
        Pr {
          number: 1441,
          html_url: Url::parse("https://github.com/release-plz/release-plz/pull/1441").unwrap()
        },
        Pr {
          number: 1440,
          html_url: Url::parse("https://github.com/release-plz/release-plz/pull/1440").unwrap()
        },
        Pr {
          number: 1439,
          html_url: Url::parse("https://github.com/release-plz/release-plz/pull/1439").unwrap()
        },
        Pr {
          number: 1438,
          html_url: Url::parse("https://github.com/release-plz/release-plz/pull/1438").unwrap()
        },
        Pr {
          number: 1437,
          html_url: Url::parse("https://github.com/release-plz/release-plz/pull/1437").unwrap()
        },
      ]
    );
  }
